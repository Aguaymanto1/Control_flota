...
namespace Control_flota.Migrations
{
    ...
    [Migration("20260609162739_AgregarEntregaEpp")]
    partial class AgregarEntregaEpp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Control_flota.Models.Finanzas.Factura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("SobrecostosJson")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Control_flota.Models.Login.Usuario", b =>
                {
            ...
            modelBuilder.Entity("Control_flota.Models.Operaciones.ConsumoCombustible", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Control_flota.Models.Operaciones.EntregaEpp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("EntregoBotas")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("EntregoCasco")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("EntregoChaleco")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Control_flota.Models.Operaciones.EstadoInicialRuta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("CombustibleInicial")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("EstadosInicialesRuta");
                });

            modelBuilder.Entity("Control_flota.Models.Operaciones.GastoRuta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("GastosRuta");
                });

            modelBuilder.Entity("Control_flota.Models.Operaciones.IncidenciaRuta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Control_flota.Models.Operaciones.Orden", b =>
                {
                    ...
                    b.Property<string>("UltimaCiudad")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Control_flota.Models.Operaciones.GastoRuta", b =>
                {
                    b.HasOne("Control_flota.Models.Operaciones.Orden", "Orden")
                        .WithMany("Gastos")
            ...
            modelBuilder.Entity("Control_flota.Models.Operaciones.Orden", b =>
                {
                    ...
                    b.HasOne("Control_flota.Models.Operaciones.SolicitudServicio", "SolicitudServicio")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Control_flota.Models.Login.Usuario", null)
                        .WithMany()
